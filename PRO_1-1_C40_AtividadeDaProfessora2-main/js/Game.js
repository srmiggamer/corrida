...
showLife() {
  push();
    image(lifeImage, width / 2 - 130, height - player.positionY - 580, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 580, 185, 20);
    fill("#f50057");
    rect(width / 2 - 100, height - player.positionY - 580, player.life, 20);
    noStroke();
    pop();
}
...
showFuelBar() {
  push();
  image(fuelImage, width / 2 - 130, height - player.positionY - 550, 20, 20);
  fill("white");
